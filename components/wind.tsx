...
function Wind({ daily }: IPropsDaily) {
  return (
    <div className="flex flex-col  items-center md:col-start-3 md:row-start-2 p-8 rounded-md mx-4 mb-3 md:m-0 md:w-full md:item-center sm:px-12 dark:bg-gray-900 dark:text-gray-100">
