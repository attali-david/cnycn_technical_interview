...
function Wind({ daily }: IPropsDaily) {
  return (
    <div className="flex flex-col m-auto items-center md:col-start-3 md:row-start-3 p-8 rounded-md mx-4 mb-3 md:w-60 sm:px-12 dark:bg-gray-900 dark:text-gray-100">
