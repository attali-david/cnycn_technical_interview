...
function Humidity({ daily }: IPropsDaily) {
  return (
    <div className="flex flex-col md:col-start-4 md:row-start-3 items-center p-8 rounded-md mx-4 mb-3 md:m-0 md:w-60 sm:px-12 dark:bg-gray-900 dark:text-gray-100">
