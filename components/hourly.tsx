...
function Hourly({ daily }: IPropsDaily) {
  return (
    <div className="col-span-2 md:col-span-2 max-w-md p-8 mx-4 mb-3 md:m-auto grid-span-2 md:col-start-0 md:row-start-3 rounded-lg dark:bg-gray-900 dark:text-gray-100">
