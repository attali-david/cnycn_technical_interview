...
function FeelsLike({ daily }: IPropsDaily) {
  return (
    <div className="flex flex-col items-center p-8 rounded-md mx-4 mb-3 md:m-0 md:w-full md:col-start-3 md:row-start-1 md:justify-items-center md:w-60 sm:px-12 dark:bg-gray-900 dark:text-gray-100">
