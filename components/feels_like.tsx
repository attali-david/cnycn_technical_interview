...
function FeelsLike({ daily }: IPropsDaily) {
  return (
    <div className="flex flex-col items-center p-8 rounded-md mx-4 mb-3 md:mx-auto md:mb-0 md:justify-items-center md:w-60 sm:px-12 dark:bg-gray-900 dark:text-gray-100">
