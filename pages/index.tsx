...
const Home: NextPage = ({ weather, selectedCity }) => {
  return (
    <div className="bg-white p-10 text-black dark:bg-gray-800 dark:text-gray-100 grid grid-cols-1 md:grid-rows-2 md:grid-cols-2 justify-items-center gap-8">
      {/* <Daily weather={weather} /> */}
      <Sunset />
      <div className="max-w-md w-full p-8 mx-auto rounded-lg dark:bg-gray-900 dark:text-gray-100">
      ...
      <div className="max-w-md w-full p-8 mx-auto rounded-lg dark:bg-gray-900 dark:text-gray-100 md:order-last">
        <div className="flex justify-between mt-8 space-x-4 dark:text-gray-400">
          <div className="flex flex-col items-center space-y-1">
            <span className="uppercase">wed</span>
            <svg
